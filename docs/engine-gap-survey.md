...
| ~~**3**~~ | ~~BM Hunter, LW Ranged, LW Melee~~ **done**; SM/DS Warlock, Firelock | ~~pets~~ **done** |

**Twenty of twenty profiles are now in reach, and eighteen are done.** The Shaman needed no engine change — the fourth
